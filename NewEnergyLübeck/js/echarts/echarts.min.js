! function (t, e) {
    ...
    function xe(t, e, n) {
        if (Qf.domSupported && t.getBoundingClientRect) {
            ...
            if (ge(Tp, t, i, r)) return n.zrX = Tp[0], void(n.zrY = Tp[1])
        }
        n.zrX = n.zrY = 0
    }
    ...
    function Je(t, e) {
        if (t) {
            ...
            if (i in jp) return $e(e, jp[i]), Qe(t, e), e;
            if ("#" !== i.charAt(0)) {
                var r = i.indexOf("("),
                    a = i.indexOf(")");
                if (-1 !== r && a + 1 === i.length) {
    ...
    function tn(t, e) {
        var n = (parseFloat(t[0]) % 360 + 360) % 360 / 360,
            ...
            a = .5 >= r ? r * (i + 1) : r + i - r * i,
            o = 2 * r - a;
        return e = e || [], Ke(e, We(255 * je(o, a, n + 1 / 3)), We(255 * je(o, a, n)), We(255 * je(o, a, n - 1 / 3)), 1), 4 === t.length && (e[3] = t[3]), e
    }
    ...
    function an(t, e, n) {
        if (e && e.length && t >= 0 && 1 >= t) {
            ...
            var i = t * (e.length - 1),
                ...
                s = e[a],
                l = i - r;
            return n[0] = We(Ze(o[0], s[0], l)), n[1] = We(Ze(o[1], s[1], l)), n[2] = We(Ze(o[2], s[2], l)), n[3] = Ue(Ze(o[3], s[3], l)), n
        }
    }
    ...
    function sn(t, e, n, i) {
        return t = Je(t), t ? (t = en(t), null != e && (t[0] = Xe(e)), null != n && (t[1] = qe(n)), null != i && (t[2] = qe(i)), un(tn(t), "rgba")) : void 0
    }
        ...
        if (u) {
            ...
            if (a || !x) {
                ...
                var B = function (t, e) {
                        ...
                        if (0 !== i)
                            if (T = (e - m[n]) / i, l)
                                if (D = y[n], C = y[0 === n ? n : n - 1], A = y[n > u - 2 ? u - 1 : n + 1], k = y[n > u - 3 ? u - 1 : n + 2], f) mn(C, D, A, k, T, T * T, T * T * T, o(t, r), v);
                                else {
                                    var a;
                                    if (p) a = mn(C, D, A, k, T, T * T, T * T * T, O, 1), a = xn(O);
                                    else {
                                        if (g) return fn(D, A, T);
                            ...
                            var a;
                            if (p) pn(y[n], y[n + 1], T, O, 1), a = xn(O);
                            else {
    ...
    function Bn(t, e, n, i) {
        ...
        if (!(2 > r)) {
            var a = 0;
            if (fg > r) return a = Dn(t, n, i, e), void kn(t, n, i, n + a, e);
            var o = new On(t, e),
                s = Cn(r);
            do {
                if (a = Dn(t, n, i, e), s > a) {
    ...
    function Xn(t, e) {
        ...
        return kg > Pg && (kg = 0, Ag = {}), kg++, Ag[n] = r, r
    }
    ...
    function ri(t, e) {
        ...
        for (var i, r = Lg.lastIndex = 0; null != (i = Lg.exec(t));) {
            var a = i.index;
            a > r && ai(n, t.substring(r, a)), ai(n, i[2], i[1]), r = Lg.lastIndex
        }
        ...
        for (var p = 0; p < o.length; p++) {
            for (var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
                var _ = g.tokens[y],
                    ...
                    S = _.textHeight = A(x.textHeight, ei(b));
    ...
    function ci(t, e, n, i, r, a) {
        ...
        if (s || d) {
            ...
            d && (C += d[1] + d[3]);
            var D = jn(_, C, w);
            s && mi(t, e, i, D, S, C, g), d && (M = Mi(_, w, d), I += d[0])
        }
    ...
    function fi(t, e, n, i, r) {
        ...
        for (var _ = 0; _ < n.lines.length; _++) {
            for (var x, w = n.lines[_], b = w.tokens, S = b.length, M = w.lineHeight, I = w.width, T = 0, C = v, D = y, A = S - 1; S > T && (x = b[T], !x.textAlign || "left" === x.textAlign);) gi(t, e, x, i, M, m, C, "left"), I -= x.width, C += x.width, T++;
            for (; A >= 0 && (x = b[A], "right" === x.textAlign);) gi(t, e, x, i, M, m, D, "right"), I -= x.width, D -= x.width, A--;
            for (C += (a - (C - v) - (y - D) - I) / 2; A >= T;) x = b[T], gi(t, e, x, i, M, m, C + x.width / 2, "center"), C += x.width, T++;
            m += M
        }
    }
    ...
    function ki(t, e, n) {
        return qg.copy(t.getBoundingRect()), t.transform && qg.applyTransform(t.transform), jg.width = e, jg.height = n, !qg.intersect(jg)
    }
    ...
    function qi(t, e) {
        xp.call(this), this.dom = t, this.painterRoot = e, this._localHandlerScope = new Yi(t, nv), Qg && (this._globalHandlerScope = new Yi(document, iv)), this._pointerCapturing = !1, this._mayPointerCapture = null, Hi(this, this._localHandlerScope)
    }
        ...
        if (wr(h) && wr(c))
            ...
            if (wr(g)) {
                ...
                var y = Tv(g),
                    _ = h * s + 1.5 * o * (-c + y),
                    x = h * s + 1.5 * o * (-c - y);
                _ = 0 > _ ? -Iv(-_, kv) : Iv(_, kv), x = 0 > x ? -Iv(-x, kv) : Iv(x, kv);
                var p = (-s - (_ + x)) / (3 * o);
                p >= 0 && 1 >= p && (a[f++] = p)
            } else {
                var w = (2 * h * s - 3 * o * c) / (2 * Tv(h * h * h)),
                    b = Math.acos(w) / 3,
                    S = Tv(h),
                    M = Math.cos(b),
                    p = (-s - 2 * S * M) / (3 * o),
                    m = (-s + S * (M + Av * Math.sin(b))) / (3 * o),
                    I = (-s + S * (M - Av * Math.sin(b))) / (3 * o);
    ...
    function Dr(t, e, n, i, r, a, o, s, l, u, h) {
        var c, d, f, p, g, v = .005,
            m = 1 / 0;
        Pv[0] = l, Pv[1] = u;
        for (var y = 0; 1 > y; y += .05) Lv[0] = Sr(t, n, r, o, y), Lv[1] = Sr(e, i, a, s, y), p = mp(Pv, Lv), m > p && (c = y, m = p);
        m = 1 / 0;
        for (var _ = 0; 32 > _ && !(Dv > v); _++) d = c - v, f = c + v, Lv[0] = Sr(t, n, r, o, d), Lv[1] = Sr(e, i, a, s, d), p = mp(Lv, Pv), d >= 0 && m > p ? (c = d, m = p) : (Ov[0] = Sr(t, n, r, o, f), Ov[1] = Sr(e, i, a, s, f), g = mp(Ov, Pv), 1 >= f && m > g ? (c = f, m = g) : v *= .5);
        return h && (h[0] = Sr(t, n, r, o, c), h[1] = Sr(e, i, a, s, c)), Tv(m)
    }
    ...
    function Br(t, e, n, i, r, a, o, s, l) {
        ...
        for (var d = 0; 1 > d; d += .05) {
            Lv[0] = Ar(t, n, r, d), Lv[1] = Ar(e, i, a, d);
            var f = mp(Pv, Lv);
            c > f && (u = d, c = f)
        }
        c = 1 / 0;
        for (var p = 0; 32 > p && !(Dv > h); p++) {
            var g = u - h,
                v = u + h;
            Lv[0] = Ar(t, n, r, g), Lv[1] = Ar(e, i, a, g);
            var f = mp(Lv, Pv);
            if (g >= 0 && c > f) u = g, c = f;
            else {
                Ov[0] = Ar(t, n, r, v), Ov[1] = Ar(e, i, a, v);
                var m = mp(Ov, Pv);
                1 >= v && c > m ? (u = v, c = m) : h *= .5
            }
        }
        return l && (l[0] = Ar(t, n, r, u), l[1] = Ar(e, i, a, u)), Tv(c)
    }
    ...
    function jr(t, e, n, i, r, a, o, s, l, u) {
        ...
        for (var c, d, f = 0, p = -1, g = 0; h > g; g++) {
            var v = lm[g],
                m = 0 === v || 1 === v ? .5 : 1,
                y = Sr(t, n, r, o, v);
            l > y || (0 > p && (p = Tr(e, i, a, s, um), um[1] < um[0] && p > 1 && qr(), c = Sr(e, i, a, s, um[0]), p > 1 && (d = Sr(e, i, a, s, um[1]))), f += 2 === p ? v < um[0] ? e > c ? m : -m : v < um[1] ? c > d ? m : -m : d > s ? m : -m : v < um[0] ? e > c ? m : -m : c > s ? m : -m)
        }
        return f
    }
    ...
    function $r(t, e, n, i, r) {
        for (var a = 0, o = 0, s = 0, l = 0, u = 0, h = 0; h < t.length;) {
            var c = t[h++];
            switch (c === am.M && h > 1 && (n || (a += Ur(o, s, l, u, i, r))), 1 === h && (o = t[h], s = t[h + 1], l = o, u = s), c) {
                case am.M:
                    l = t[h++], u = t[h++], o = l, s = u;
                    break;
                case am.L:
                ...
                case am.R:
                    ...
                    } else a += Ur(_, u, _, x, i, r), a += Ur(l, x, l, u, i, r);
                    break;
                case am.Z:
                    if (n) {
    ...
    function na(t) {
        ...
        for (var e, n = 0, i = 0, r = n, a = i, o = new nm, s = nm.CMD, l = t.match(Im), u = 0; u < l.length; u++) {
            for (var h, c = l[u], d = c.charAt(0), f = c.match(Tm) || [], p = f.length, g = 0; p > g; g++) f[g] = parseFloat(f[g]);
            for (var v = 0; p > v;) {
    ...
    function Ca(t) {
        ...
        if (e && !t.__highlighted) {
            ...
            if (t.__highlighted = i ? "layer" : "plain", !(t.isGroup || !n && t.useHoverLayer)) {
                var r = t,
                    a = t.style;
                i && (r = n.addHover(t), a = r.style), Ka(a), i || Ta(r), a.extendFrom(e), Da(a, e, "fill"), Da(a, e, "stroke"), Za(a), i || (t.dirty(!1), t.z2 += Jm)
            }
        }
    }
    ...
    function Pa(t, e) {
        e = t.__hoverStl = e !== !1 && (t.hoverStyle || e || {}), t.__hoverStlDirty = !0, t.__highlighted && (t.__cachedNormalStl = null, Aa(t), Ca(t))
    }
    ...
    function Na(t, e) {
        ...
        if (t.__highDownSilentOnTouch = t.highDownSilentOnTouch, t.__highDownOnUpdate = t.highDownOnUpdate, !n || t.__highDownDispatcher) {
            var i = n ? "off" : "on";
            t[i]("mouseover", La)[i]("mouseout", Oa), t[i]("emphasis", Ba)[i]("normal", Ea), t.__highByOuter = t.__highByOuter || 0, t.__highDownDispatcher = !n
        }
    }
    ...
    function Ha(t, e, n, i, r, a, o) {
        ...
        var p = d ? s : null,
            g = f ? A(l ? l.getFormattedLabel(u, "emphasis", null, h, c) : null, s) : null;
    ...
    function eo(t, e) {
        for (var n = Oe([]); t && t !== e;) Ee(n, t.getLocalTransform(), n), t = t.parent;
        return n
    }
    ...
    function Vo(t, e, n) {
        ...
        for (var r = e[0].$vars || [], a = 0; a < r.length; a++) {
            var o = Iy[a];
            t = t.replace(Ty(o), Ty(o, 0))
        }
        for (var s = 0; i > s; s++)
            for (var l = 0; l < r.length; l++) {
                var u = e[s][r[l]];
                t = t.replace(Ty(Iy[l], s), n ? Fo(u) : u)
            }
        return t
    }
    ...
    function ss(t, e, n, i, r) {
        ...
        var a, o;
        if (e === Hy) "auto" === i || null == i ? us(function (t) {
            null != t && "-" !== t && (b(t) ? null == o && (o = 1) : o = 0)
        }, n, t, 10) : o = i ? 1 : 0, r || 1 !== o || (r = [], us(function (t, e) {
            r[e] = null != t ? t : ""
        }, n, t)), a = r ? r.length : n === qy ? t.length : t[0] ? t[0].length : null;
        else if (e === Gy) r || (r = hs(t));
    ...
    function ds(t, e, n) {
        ...
        var l = function () {
            ...
            for (var i = {}, r = {}, l = [], u = 0, h = Math.min(5, n); h > u; u++) {
                ...
                l.push(c);
                var d = c === jy.Not;
                if (d && null == i.v && u !== a && (i.v = u), (null == i.n || i.n === i.v || !d && l[i.n] === jy.Not) && (i.n = u), t(i) && l[i.n] !== jy.Not) return i;
                d || (c === jy.Might && null == r.v && u !== a && (r.v = u), (null == r.n || r.n === r.v) && (r.n = u))
            }
    ...
    function gs(t, e, n, i, r, a) {
        function o(t) {
            var e = b(t);
            return null != t && isFinite(t) && "" !== t ? e ? jy.Might : jy.Not : e && "-" !== t ? jy.Must : void 0
        }
        var s, l = 5;
        if (I(t)) return jy.Not;
        var u, h;
        if (i) {
            var c = i[a];
            S(c) ? (u = c.name, h = c.type) : b(c) && (u = c)
        }
        if (null != h) return "ordinal" === h ? jy.Must : jy.Not;
        if (e === Hy)
            if (n === qy) {
    ...
    function ys(t) {
        t = t, this.option = {}, this.option[Ky] = 1, this._componentsMap = N({
            series: []
        }), this._seriesIndices, this._seriesIndicesMap, ms(t, this._theme.option), r(t, Ry, !1), this.mergeOption(t)
    }
    ...
    function Es(t) {
        t && (Os(t), Bs(t, "label"), t.emphasis && Bs(t.emphasis, "label"))
    }

    function zs(t) {
        if (o_(t)) {
            Ps(t), Os(t), Bs(t, "label"), Bs(t, "upperLabel"), Bs(t, "edgeLabel"), t.emphasis && (Bs(t.emphasis, "label"), Bs(t.emphasis, "upperLabel"), Bs(t.emphasis, "edgeLabel"));
            var e = t.markPoint;
            e && (Ps(e), Es(e));
            var n = t.markLine;
            n && (Ps(n), Es(n));
            ...
            if ("graph" === t.type) {
                ...
                if (a && !I(a))
                    for (var o = 0; o < a.length; o++) Es(a[o]);
                f(t.categories, function (t) {
                    Os(t)
                })
            }
            if (r && !I(r))
                for (var o = 0; o < r.length; o++) Es(r[o]);
            var e = t.markPoint;
            if (e && e.data)
                for (var s = e.data, o = 0; o < s.length; o++) Es(s[o]);
            var n = t.markLine;
            if (n && n.data)
                for (var l = n.data, o = 0; o < l.length; o++) x(l[o]) ? (Es(l[o][0]), Es(l[o][1])) : Es(l[o]);
            "gauge" === t.type ? (Bs(t, "axisLabel"), Bs(t, "title"), Bs(t, "detail")) : "treemap" === t.type ? (Ls(t.breadcrumb, "itemStyle"), f(t.levels, function (t) {
                Os(t)
    ...
    function Ws(t, e) {
        ...
        var n = this._data = t.data,
            i = t.sourceFormat;
        i === Uy && (this._offset = 0, this._dimSize = e, this._data = n);
    ...
    function Zs(t, e) {
        ...
        return "time" === n && "number" != typeof t && null != t && "-" !== t && (t = +ko(t)), null == t || "" === t ? 0 / 0 : +t
    }
    ...
    function hl() {
        this.group = new dg, this.uid = vo("viewChart"), this.renderTask = Qs({
            plan: fl,
            reset: pl
    ...
    function cl(t, e, n) {
        if (t && (t.trigger(e, n), t.isGroup && !Fa(t)))
            for (var i = 0, r = t.childCount(); r > i; i++) cl(t.childAt(i), e, n)
    }
    ...
    function pl(t) {
        var e = t.model,
            ...
            o = t.view,
            s = r && T_(r).updateMethod,
            l = a ? "incrementalPrepareRender" : s && o[s] ? s : "render";
        return "render" !== l && o[l](e, n, i, r), A_[l]
    }
    ...
    function vl(t, e, n, i) {
        ...
        if (r) {
            ...
            if (s !== n || o !== i) {
                ...
                r = t[e] = gl(a, n, "debounce" === i), r[k_] = a, r[L_] = i, r[P_] = n
            }
            return r
        }
    }
    ...
    function xl(t, e, n, i, r) {
        function a(e) {
            ...
            i || (i = s.set(n, Qs({
                ...
                overallProgress: h,
                modifyOutputEnd: c
            }, i.agent = o, i.__block = h, Al(t, e, i)
        }
    ...
    function Rl(t, e, n, i) {
        var r = e.__inheritedStyle || {},
            a = "text" === e.type;
        if (1 === t.nodeType && (Fl(t, e), o(r, Vl(t)), !i))
            for (var s in tx)
        ...
        var c = e.style;
        null != r.fill && c.set(u, Nl(r.fill, n)), null != r.stroke && c.set(h, Nl(r.stroke, n)), f(["lineWidth", "opacity", "fillOpacity", "strokeOpacity", "miterLimit", "fontSize"], function (t) {
    ...
    function Xl(t, e, n) {
        ...
        var e = i(e);
        e && c_(e, !0), this._theme = e, this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._coordSysMgr = new Ms;
        var s = this._api = lu(this);
        Bn(Fx, r), Bn(zx, r), this._scheduler = new ml(this, s, zx, Fx), xp.call(this, this._ecEventProcessor = new uu), this._messageCenter = new Wl, this._initEvents(), this.resize = y(this.resize, this), this._pendingActions = [], o.animation.on("frame", this._onframe, this), Ql(o, this), E(this)
    }
    ...
    function Yl(t) {
        var e = t._model,
            n = t._scheduler;
        n.restorePipelines(e), n.prepareStageTasks(), Jl(t, "component", e, n), Jl(t, "chart", e, n), n.plan()
    }
    ...
    function Zl(t, e) {
        ...
        }, this), "none" === u || g || l || (this[Ax] ? (Yl(this), Lx.update.call(this, t), this[Ax] = !1) : Lx[u].call(this, t)), d = c ? {
            type: a.event || n,
            escapeConnect: i,
            batch: f
    ...
    function Ql(t, e) {
        t.on("rendered", function () {
            e.trigger("rendered"), !t.animation.isFinished() || e[Ax] || e._scheduler.unfinished || e._pendingActions.length || e.trigger("finished")
        })
    }
    ...
    function Jl(t, e, n, i) {
        function r(t) {
            ...
            if (!r) {
                var h = cx(t.type),
                    c = a ? S_.getClass(h.main, h.sub) : hl.getClass(h.sub);
    ...
    function eu(t, e, n, i) {
        nu(t, e, n, i), lx(t._chartsViews, function (t) {
            t.__alive = !1
        }), iu(t, e, n, i), lx(t._chartsViews, function (t) {
    ...
    function iu(t, e, n, i, r) {
        ...
        e.eachSeries(function (e) {
            ...
            n.__alive = !0;
            var s = n.renderTask;
            o.updatePayload(s, i), r && r.get(e.uid) && s.dirty(), a |= s.perform(o.getPerformArgs(s)), n.group.silent = !!e.get("silent"), su(e, n), ou(e, n)
        }), o.unfinished |= a, au(t, e), E_(t._zr.dom, e)
    }
    ...
    function cu(t, e, n) {
        ...
        if (i) return i;
        var r = new Xl(t, e, n);
        return r.id = "ec_" + Xx++, Gx[r.id] = r, cr(t, Yx, r.id), hu(r), r
    }
    ...
    function pu(t) {
        "string" == typeof t ? t = Gx[t] : t instanceof Xl || (t = gu(t)), t instanceof Xl && !t.isDisposed() && t.dispose()
    }
    ...
    function wu(t, e, n) {
        ...
        t.event = (t.event || i).toLowerCase(), e = t.event, sx(kx.test(i) && kx.test(e)), Bx[i] || (Bx[i] = {
            action: n,
            actionInfo: t
        }), Ex[e] = i
    }
    ...
    function zu(t, e, n, i, r) {
        this._old = t, this._new = e, this._oldKeyGetter = n || Eu, this._newKeyGetter = i || Eu, this.context = r
    }
    ...
    function Nu(t) {
        ...
        f(t.dimensions, function (e) {
            ...
            if (l) {
                ...
                Fu(n, l)[u] = e, s.isExtraCoord || (i.set(l, 1), Hu(s.type) && (r[0] = e), Fu(o.encode, l)[u] = s.index), s.defaultTooltip && a.push(e)
            }
    ...
    function $u(t, e) {
        var n = t._idList[e];
        return null == n && (n = ju(t, t._idDimIdx, e)), null == n && (n = Jx + e), n
    }
    ...
    function Ju(t, e) {
        ...
        for (var r = i._storage = {}, a = t._storage, o = 0; o < n.length; o++) {
            var s = n[o];
            a[s] && (u(e, s) >= 0 ? (r[s] = th(a[s]), i._rawExtent[s] = eh(), i._extent[s] = null) : r[s] = a[s])
        }
        return i
    }

    function th(t) {
        for (var e = new Array(t.length), n = 0; n < t.length; n++) e[n] = Xu(t[n]);
        return e
    }
    ...
    function nh(t, e, n) {
        ...
        for (var a = (n.dimsDef || []).slice(), l = N(), u = N(), h = [], c = ih(e, t, a, n.dimCount), d = 0; c > d; d++) {
        ...
        for (var M = _ || "value", I = 0; c > I; I++) {
            var v = h[I] = h[I] || new Gu,
                T = v.coordDim;
            null == T && (v.coordDim = rh(M, u, w), v.coordDimIndex = 0, (!_ || 0 >= x) && (v.isExtraCoord = !0), x--), null == v.name && (v.name = rh(v.coordDim, l)), null != v.type || ps(e, I, v.name) !== jy.Must && (!v.isExtraCoord || null == v.otherDims.itemName && null == v.otherDims.seriesName) || (v.type = "ordinal")
        }
        return h
    }
    ...
    function ch(t, e, n) {
        ...
        var s, l, u = uw(t, {
            ...
            encodeDefaulter: n.useEncodeDefaulter ? _(cs, i, e) : null
        });
        o && f(u, function (t, e) {
            var n = t.coordDim,
        ...
        var d = null != s && dh(t) ? function (t, e, n, i) {
    ...
    function Dh(t, e, n) {
        if (t && e) {
            var i = t[Sh(e)];
            return null != i && null != n && (i = i[bh(n)]), i
        }
    }
    ...
    function Ah(t, e) {
        ...
        f(n, function (t) {
            ...
            for (var d = e.mapDimension(h.dim), f = e.mapDimension(a.dim), p = uh(e, d), g = h.isHorizontal(), v = Lh(a, h, p), m = 0, y = e.count(); y > m; m++) {
                var _ = e.get(d, m),
                    x = e.get(f, m),
                    w = _ >= 0 ? "p" : "n",
                    b = v;
                ...
                if (g) {
                    ...
                    S = b, M = C[1] + l, I = C[0] - v, T = u, Math.abs(I) < c && (I = (0 > I ? -1 : 1) * c), isNaN(I) || p && (r[o][x][w] += I)
                } else {
                    var C = n.dataToPoint([x, _]);
                    S = C[0] + l, M = b, I = u, T = C[1] - v, Math.abs(T) < c && (T = (0 >= T ? -1 : 1) * c), isNaN(T) || p && (r[o][x][w] += T)
                }
                e.setItemLayout(m, {
                    x: S,
                    y: M,
    ...
    function Bh(t, e) {
        var n, i, r, a = t.type,
            ...
            s = e.getMax(),
            l = t.getExtent();
        "ordinal" === a ? n = e.getCategories().length : (i = e.get("boundaryGap"), x(i) || (i = [i || 0, i || 0]), "boolean" == typeof i[0] && (i = [0, 0]), i[0] = wo(i[0], 1), i[1] = wo(i[1], 1), r = l[1] - l[0] || Math.abs(l[0])), "dataMin" === o ? o = l[0] : "function" == typeof o && (o = o({
            min: l[0],
            max: l[1]
        ...
        var u = null != o,
            h = null != s;
        null == o && (o = "ordinal" === a ? n ? 0 : 0 / 0 : l[0] - i[0] * r), null == s && (s = "ordinal" === a ? n ? n - 1 : 0 / 0 : l[1] + i[1] * r), (null == o || !isFinite(o)) && (o = 0 / 0), (null == s || !isFinite(s)) && (s = 0 / 0), t.setBlank(C(o) || C(s) || "ordinal" === a && !t.getOrdinalMeta().categories.length), e.getNeedCrossZero() && (o > 0 && s > 0 && !u && (o = 0), 0 > o && 0 > s && !h && (s = 0));
        var c = e.ecModel;
        if (c && "time" === a) {
            var d, p = Mh("bar", c);
            if (f(p, function (t) {
    ...
    function Rh(t, e) {
        if (e = e || t.get("type")) switch (e) {
            ...
            case "value":
                return new vw;
            default:
                return (ph.getClass(e) || vw).create(t)
        }
    }
    ...
    function Fh(t) {
        ...
        return "string" == typeof e ? e = function (e) {
            ...
            return null != n && (r = i - n), e(Vh(t, i), r)
        } : function (e) {
    ...
    function Yh(t, e, n, i, r, a, o) {
        var s = 0 === t.indexOf("empty");
        s && (t = t.substr(5, 1).toLowerCase() + t.substr(6));
        var l;
        return l = 0 === t.indexOf("image://") ? _a(t.slice(8), new Tn(e, n, i, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? ya(t.slice(7), {}, new Tn(e, n, i, r), o ? "center" : "cover") : new jw({
            shape: {
                symbolType: t,
                x: e,
                y: n,
    ...
    function jh(t, e) {
        ...
        var i = Rh(n);
        return i.setExtent(t[0], t[1]), zh(i, n), i
    }
    ...
    function $h(t, e, n) {
        ...
        var s = t[0];
        return Kh(r[0], s[0]) && Kh(r[1], s[1]) || (i += Ur(r[0], r[1], s[0], s[1], e, n)), 0 !== i
    }
    ...
    function ec(t) {
        return "category" === t.type ? ic(t) : oc(t)
    }

    function nc(t, e) {
        return "category" === t.type ? ac(t, e) : {
    ...
    function rc(t, e) {
        ...
        if (r) return r;
        var a, o;
        return w(i) ? a = pc(t, i) : (o = "auto" === i ? hc(t) : i, a = fc(t, o)), uc(n, i, {
            labels: a,
    ...
    function ac(t, e) {
        ...
        if (r) return r;
        var a, o;
        if ((!e.get("show") || t.scale.isBlank()) && (a = []), w(i)) a = pc(t, i, !0);
        else if ("auto" === i) {
    ...
    function bc(t, e, n, i) {
        ...
        if (l) {
            if (null != u) Sc(o[u]) && (a = o[u]);
                ...
                for (var h in o)
                    if (o.hasOwnProperty(h) && Sc(o[h]) && !i[r(o[h])]) {
                        a = o[h];
                        break
                    } a && (i[r(a)] = !0)
        }
    ...
    function Lc(t, e, n) {
        return t ? "polar" === t.type ? Pc(t, e, n) : "cartesian2d" === t.type ? kc(t, e, n) : null : null
    }
    ...
    function Rc(t, e, n, i, r, a, o, l) {
        ...
        l || Dc(t.style, f, i, u, a, n, g), zc(r) && (f.fill = f.stroke = "none"), Ra(t, f)
    }
    ...
    function Fc(t, e, n) {
        ...
        e.add(f), Hc(f, t, i), f.seriesIndex = t.seriesIndex, t.get("silent") || (f.on("mousedown", Cb), f.on("mousemove", Cb))
    }
    ...
    function Uc(t, e, n, i) {
        ...
        return Ao(o - Db / 2) ? (a = l ? "bottom" : "top", r = "center") : Ao(o - 1.5 * Db) ? (a = l ? "top" : "bottom", r = "center") : (a = "middle", r = 1.5 * Db > o && o > Db / 2 ? l ? "left" : "right" : l ? "right" : "left"), {
            rotation: o,
            textAlign: r,
            textVerticalAlign: a
        }
    ...
    function $c(t, e, n) {
        ...
        if (r.get("show") && !i.scale.isBlank()) {
            for (var a = r.getModel("lineStyle"), o = n.tickDirection * r.get("length"), l = i.getTicksCoords(), u = Kc(l, t._transform, o, s(a.getLineStyle(), {
        ...
        if (r.get("show") && !i.scale.isBlank()) {
            ...
            if (a.length)
                for (var o = r.getModel("lineStyle"), l = n.tickDirection * r.get("length"), u = s(o.getLineStyle(), s(e.getModel("axisTick").getLineStyle(), {
                    ...
                    for (var c = Kc(a[h], t._transform, l, u, "minorticks_" + h), d = 0; d < c.length; d++) t.group.add(c[d])
        }
    }
    ...
    function Jc(t, e, n) {
        ...
        if (r && !i.scale.isBlank()) {
            var a = e.getModel("axisLabel"),
                ...
                u = Lb(n.rotation, l, n.labelDirection),
    ...
    function td(t, e) {
        ...
        return ed(n, t, e), n.seriesInvolved && id(n, t), n
    }
        ...
        Bb(n.getCoordinateSystems(), function (n) {
            function s(i, s, l) {
                var h = l.model.getModel("axisPointer", r),
                    d = h.get("show");
                if (d && ("auto" !== d || i || ud(h))) {
                    null == s && (s = h.get("triggerTooltip")), h = i ? nd(l, c, r, e, i, s) : h;
                    var f = h.get("snap"),
                        p = hd(l.model),
    ...
    function id(t, e) {
        e.eachSeries(function (e) {
            ...
            n && "none" !== i && i !== !1 && "item" !== i && r !== !1 && e.get("axisPointer.show", !0) !== !1 && Bb(t.coordSysAxesInfo[hd(n.model)], function (t) {
                var i = t.axis;
    ...
    function rd(t, e) {
        for (var n = e.model, i = e.dim, r = 0; r < t.length; r++) {
            var a = t[r] || {};
            if (ad(a[i + "AxisId"], n.id) || ad(a[i + "AxisIndex"], n.componentIndex) || ad(a[i + "AxisName"], n.name)) return r
        }
    }
    ...
    function cd(t, e, n, i, r, a) {
        var o = zb.getAxisPointerClass(t.axisPointerClass);
        if (o) {
            var s = ld(e);
            s ? (t._axisPointer || (t._axisPointer = new o)).render(e, s, i, a) : dd(t, i)
        }
    }
    ...
    function xd(t) {
        this.group = new dg, this._symbolCtor = t || vd
    }
    ...
    function Ad(t, e, n, i, r, a, o, s, l, u) {
    ...
    function Pd(t, e, n, i, r, a, o, s, l, u, h) {
        for (var c = 0, d = n, f = 0; i > f; f++) {
            var p = e[d];
            if (d >= r || 0 > d) break;
            if (Dd(p)) {
    ...
    function zd(t, e, n) {
        ...
        for (var i = [], r = 0, a = e.count(); a > r; r++) i.push(Td(n, t, e, r));
        return i
    }
    ...
    function Vd(t, e) {
        ...
        for (var r = e.count(), a = Math.max(1, Math.round(r / 5)), o = 0; r > o; o += a)
            if (1.5 * vd.getSymbolSize(e, o)[t.isHorizontal() ? 1 : 0] > i) return !1;
        return !0
    }
    ...
    function Wd(t, e, n, i) {
        ...
        i.dispatchAction({
            ...
            Xd(r.getItemGraphicEl(t), r.getItemLayout(t), e.isSelected(r.getName(t)), s, n)
        })
    }
    ...
    function Yd(t, e, n, i, r, a, o, s, l, u) {
        function h(e, n, i) {
    ...
    function qd(t, e, n, i, r, a, o, s) {
        ...
        Yd(u, e, n, i, 1, r, a, o, s, c), Yd(l, e, n, i, -1, r, a, o, s, h);
            ...
            if (!jd(f)) {
                ...
                if (p) {
                    var g, v = "edge" === f.labelAlignTo,
                        m = f.textRect.width;
                    g = v ? f.x < e ? p[2][0] - f.labelDistance - o - f.labelMargin : o + r - f.labelMargin - p[2][0] - f.labelDistance : f.x < e ? f.x - o - f.bleedMargin : o + r - f.x - f.bleedMargin, g < f.textRect.width && (f.text = $n(f.text, g, f.font), "edge" === f.labelAlignTo && (m = Xn(f.text, f.font)));
                    var y = p[1][0] - p[2][0];
    ...
    function af(t, e) {
        var n = e.axis,
            ...
            o = Number.MAX_VALUE,
            s = -1;
        return ES(e.seriesModels, function (e) {
            ...
            if (null != l && isFinite(l)) {
                var d = t - l,
                    f = Math.abs(d);
                o >= f && ((o > f || d >= 0 && 0 > s) && (o = f, s = d, r = l, a.length = 0), ES(u, function (t) {
                    a.push({
    ...
    function uf(t, e, n, i) {
        if (ff(e) || !t.list.length) return void i({
            type: "hideTip"
        });
    ...
    function hf(t, e, n) {
        ...
        ES(t, function (t) {
            ...
            "show" === e.status && ES(e.seriesDataIndices, function (t) {
    ...
    function pf(t, e, n) {
        if (!Qf.node) {
            var i = e.getZr();
            FS(i).records || (FS(i).records = {}), gf(i, e);
            var r = FS(i).records[t] || (FS(i).records[t] = {});
            r.handler = n
        }
    }
    ...
    function gf(t, e) {
        function n(n, i) {
            t.on(n, function (n) {
                var r = _f(e);
                VS(FS(t).records, function (t) {
                    t && i(t, n, r.dispatchAction)
                }), vf(r.pendings, e)
            })
        }
        FS(t).initialized || (FS(t).initialized = !0, n("click", _(yf, "click")), n("mousemove", _(yf, "mousemove")), n("globalout", mf))
    }
    ...
    function bf(t, e, n, i) {
        Sf(GS(n).lastProp, i) || (GS(n).lastProp = i, e ? Ja(n, i, t) : (n.stopAnimation(), n.attr(i)))
    }
    ...
    function Df(t, e, n, i, r) {
        var a = n.get("value"),
            o = kf(a, e.axis, e.ecModel, n.get("seriesDataIndices"), {
        ...
        "bottom" === g && (c[1] -= f), "middle" === g && (c[1] -= f / 2), Af(c, d, f, i);
    ...
    function Lf(t, e, n, i, r, a) {
        var o = Ab.innerTextLayout(n.rotation, 0, n.labelDirection);
        n.labelMargin = r.get("label.margin"), Df(e, i, r, a, {
            position: Pf(i.axis, t, n),
            align: o.textAlign,
    ...
    function Nf(t) {
        var e = [],
            n = t.get("fontSize"),
            i = t.getTextColor();
        return i && e.push("color:" + i), e.push("font:" + t.getFont()), n && e.push("line-height:" + Math.round(3 * n / 2) + "px"), qS(["decoration", "align"], function (n) {
            var i = t.get(n);
            i && e.push("text-" + n + ":" + i)
        }), e.join(";")
    }
    ...
    function Ff(t) {
        var e = [],
            ...
            a = t.get("padding");
        return n && e.push(Rf(n)), i && (Qf.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + rn(i)), e.push("filter:alpha(opacity=70)"))), qS(["width", "color", "radius"], function (n) {
            var i = "border-" + n,
                r = jS(i),
                a = t.get(r);
            null != a && e.push(i + ":" + a + ("color" === n ? "" : "px"))
        }), e.push(Nf(r)), null != a && e.push("padding:" + by(a).join("px ") + "px"), e.join(";") + ";"
    }
    ...
    function Hf(t, e, n) {
        ...
        this._styleCoord = [0, 0], Vf(this._styleCoord, r, a, e.getWidth() / 2, e.getHeight() / 2), a ? document.body.appendChild(i) : t.appendChild(i), this._container = t, this._show = !1, this._hideTimeout;
        var o = this;
    ...
    var Pp = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
        Lp = function (t, e, n, i) {
            xp.call(this), this.storage = t, this.painter = e, this.painterRoot = i, n = n || new Ae, this.proxy = null, this._hovered = {}, this._lastTouchMoment, this._lastX, this._lastY, this._gestureMgr, le.call(this), this.setHandlerProxy(n)
        };
    Lp.prototype = {
        constructor: Lp,
    ...
    var Op = "undefined" == typeof Float32Array ? Array : Float32Array,
    ...
    Np.updateTransform = function () {
        ...
        i = i || Le(), n ? this.getLocalTransform(i) : Ep(i), e && (n ? Ee(i, t.transform, i) : Be(i, t.transform)), this.transform = i;
    ...
    qp.put = function (t, e) {
        ...
        if (null == i[t]) {
            ...
            o ? o.value = e : o = new Up(e), o.key = t, n.insertEntry(o), i[t] = o
        }
        return r
    }, qp.get = function (t) {
        var e = this._map[t],
    ...
    Bg.measureText = function (t, e) {
        var n = l();
        return n.font = e || Og, n.measureText(t)
    };
    var Eg = Og,
        zg = {
            left: 1,
    ...
    Zg.prototype = {
        ...
        _doPaintEl: function (t, e, n, i) {
            ...
            if (!(!e.__dirty && !n || t.invisible || 0 === t.style.opacity || a && !a[0] && !a[3] || t.culling && ki(t, this._width, this._height))) {
                var o = t.__clipPaths,
                    s = i.prevElClipPaths;
                (!s || Pi(o, s)) && (s && (r.restore(), i.prevElClipPaths = null, i.prevEl = null), o && (r.save(), Li(o, r), i.prevElClipPaths = o)), t.beforeBrush && t.beforeBrush(r), t.brush(r, i.prevEl || null), i.prevEl = t, t.afterBrush && t.afterBrush(r)
            }
        },
        getLayer: function (t, e) {
            this._singleCanvas && !this._needsManuallyCompositing && (t = Xg);
            var n = this._layers[t];
            return n || (n = new Tg("zr_" + t, this, this.dpr), n.zlevel = t, n.__builtin__ = !0, this._layerConfig[t] ? r(n, this._layerConfig[t], !0) : this._layerConfig[t - Ug] && r(n, this._layerConfig[t - Ug], !0), e && (n.virtual = e), this.insertLayer(t, n), n.initContext()), n
        },
        insertLayer: function (t, e) {
            ...
            if (!Ai(e)) return void og("Layer of zlevel " + t + " is not valid");
            if (r > 0 && t > i[0]) {
        ...
        _updateLayerStatus: function (t) {
            ...
            for (var r, a = null, o = 0, n = 0; n < t.length; n++) {
                var s, i = t[n],
                    l = i.zlevel;
                r !== l && (r = l, o = 0), i.incremental ? (s = this.getLayer(l + Yg, this._needsManuallyCompositing), s.incremental = !0, o = 1) : s = this.getLayer(l + (o > 0 ? Ug : 0), this._needsManuallyCompositing), s.__builtin__ || og("ZLevel " + l + " has been used by unkown layer " + s.id), s !== a && (s.__used = !0, s.__startIndex !== n && (s.__dirty = !0), s.__startIndex = n, s.__drawIndex = s.incremental ? -1 : n, e(n), a = s), i.__dirty && (s.__dirty = !0, s.incremental && s.__drawIndex < 0 && (s.__drawIndex = n))
            }
        ...
        getRenderedCanvas: function (t) {
            ...
            var e = new Tg("image", this, t.pixelRatio || this.dpr);
    ...
    var av = !Qf.canvasSupported,
        ...
        uv = function (t, e, n) {
            ...
            var s = Qf.node || Qf.worker ? null : new qi(o.getViewportRoot(), o.root);
            this.handler = new Lp(r, o, s, o.root), this.animation = new Kg({
                stage: {
    ...
    nm.prototype = {
        ...
        getBoundingRect: function () {
            Uv[0] = Uv[1] = qv[0] = qv[1] = Number.MAX_VALUE, Yv[0] = Yv[1] = jv[0] = jv[1] = -Number.MAX_VALUE;
            for (var t = this.data, e = 0, n = 0, i = 0, r = 0, a = 0; a < t.length;) {
                var o = t[a++];
                switch (1 === a && (e = t[a], n = t[a + 1], i = e, r = n), o) {
                    case Xv.M:
                        i = t[a++], r = t[a++], e = i, n = r, qv[0] = i, qv[1] = r, jv[0] = i, jv[1] = r;
                        break;
                    case Xv.L:
                        zr(e, n, t[a], t[a + 1], qv, jv), e = t[a++], n = t[a++];
                        break;
                    case Xv.C:
                        Rr(e, n, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], qv, jv), e = t[a++], n = t[a++];
                        break;
                    case Xv.Q:
                        Nr(e, n, t[a++], t[a++], t[a], t[a + 1], qv, jv), e = t[a++], n = t[a++];
                        break;
                    case Xv.A:
                        var s = t[a++],
                            l = t[a++],
                        ...
                        a += 1;
                        var f = 1 - t[a++];
                        1 === a && (i = $v(c) * u + s, r = Qv(c) * h + l), Fr(s, l, u, h, c, d, f, qv, jv), e = $v(d) * u + s, n = Qv(d) * h + l;
                        break;
                    case Xv.R:
                        i = e = t[a++], r = n = t[a++];
                        var p = t[a++],
                            g = t[a++];
                        zr(i, r, i + p, r + g, qv, jv);
                        break;
                    case Xv.Z:
                        e = i, n = r
                }
                oe(Uv, Uv, qv), se(Yv, Yv, jv)
            }
            return 0 === a && (Uv[0] = Uv[1] = Yv[0] = Yv[1] = 0), new Tn(Uv[0], Uv[1], Yv[0] - Uv[0], Yv[1] - Uv[1])
        },
                ...
                if (n)
                    for (var r = 0; r < n.length; r++) {
                        ...
                        if (o && ("sector" === s && o.startAngle === o.endAngle || "rect" === s && (!o.width || !o.height))) {
                            for (var l = 0; l < Am.length; l++) Am[l][2] = i[Am[l][0]], i[Am[l][0]] = Am[l][1];
                            e = !0;
                            break
                        }
                    }
                if (t.apply(this, arguments), e)
                    for (var l = 0; l < Am.length; l++) i[Am[l][0]] = Am[l][2]
            } : t
        },
        Pm = ta.extend({
            type: "sector",
        ...
        Wm = ta.extend({
            ...
            buildPath: function (t, e) {
                var n = e.x1,
                    ...
                    u = e.cpy2,
                    h = e.percent;
                0 !== h && (t.moveTo(n, i), null == l || null == u ? (1 > h && (Or(n, o, r, h, Gm), o = Gm[1], r = Gm[2], Or(i, s, a, h, Gm), s = Gm[1], a = Gm[2]), t.quadraticCurveTo(o, s, r, a)) : (1 > h && (Cr(n, o, l, r, h, Gm), o = Gm[1], l = Gm[2], r = Gm[3], Cr(i, s, u, a, h, Gm), s = Gm[1], u = Gm[2], a = Gm[3]), t.bezierCurveTo(o, s, l, u, r, a)))
            },
            pointAt: function (t) {
    ...
    var qm = function (t, e, n, i, r, a) {
        this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == n ? 1 : n, this.y2 = null == i ? 0 : i, this.type = "linear", this.global = a || !1, Ym.call(this, r)
    };
    qm.prototype = {
        constructor: qm
    }, h(qm, Ym);
    var jm = function (t, e, n, i, r) {
        this.x = null == t ? .5 : t, this.y = null == e ? .5 : e, this.r = null == n ? .5 : n, this.type = "radial", this.global = r || !1, Ym.call(this, i)
    };
    jm.prototype = {
        constructor: jm
    }, h(jm, Ym), fa.prototype.incremental = !0, fa.prototype.clearDisplaybles = function () {
    ...
    var Km = Math.max,
        ...
        ly = N(),
        uy = 0;
    va("circle", Dm), va("sector", Pm), va("ring", Lm), va("polygon", Em), va("polyline", zm), va("rect", Fm), va("line", Hm), va("bezierCurve", Wm), va("arc", Xm);
    ...
    var my = 0,
        ...
        Ly = Zo,
        Oy = (_(Zo, "vertical"), _(Zo, "horizontal"), {
    ...
    var jy = {
        ...
        $y = fo.extend({
            ...
            setOption: function (t, e) {
                O(!(Ky in t), "please use chart.getOption()"), this._optionManager.setOption(t, e), this.resetOption(null)
            },
    ...
    Is.prototype = {
        ...
        setOption: function (t, e) {
            ...
            this._newBaseOption = i.baseOption, n ? (ks(n.baseOption, i.baseOption), i.timelineOptions.length && (n.timelineOptions = i.timelineOptions), i.mediaList.length && (n.mediaList = i.mediaList), i.mediaDefault && (n.mediaDefault = i.mediaDefault)) : this._optionBackup = i
        },
        ...
        getMediaOption: function () {
            ...
            for (var o = 0, s = n.length; s > o; o++) Cs(n[o].query, t, e) && r.push(o);
            return !r.length && i && (r = [-1]), r.length && !As(r, this._currentMediaIndices) && (a = n_(r, function (t) {
    ...
    var a_ = f,
        ...
        l_ = function (t, e) {
            a_(Rs(t.series), function (t) {
                o_(t) && zs(t)
            });
            var n = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
            e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), a_(n, function (e) {
                a_(Rs(t[e]), function (t) {
                    t && (Bs(t, "axisLabel"), Bs(t.axisPointer, "label"))
                })
            }), a_(Rs(t.parallel), function (t) {
                var e = t && t.parallelAxisDefault;
                Bs(e, "axisLabel"), Bs(e && e.axisPointer, "label")
            }), a_(Rs(t.calendar), function (t) {
                Ls(t, "itemStyle"), Bs(t, "dayLabel"), Bs(t, "monthLabel"), Bs(t, "yearLabel")
            }), a_(Rs(t.radar), function (t) {
                Bs(t, "name")
            }), a_(Rs(t.geo), function (t) {
                o_(t) && (Es(t), a_(Rs(t.regions), function (t) {
                    Es(t)
                }))
            }), a_(Rs(t.timeline), function (t) {
                Es(t), Ls(t, "label"), Ls(t, "itemStyle"), Ls(t, "controlStyle", !0);
                var e = t.data;
                x(e) && f(e, function (t) {
                    S(t) && (Ls(t, "label"), Ls(t, "itemStyle"))
                })
            }), a_(Rs(t.toolbox), function (t) {
                Ls(t, "iconStyle"), a_(t.feature, function (t) {
                    Ls(t, "iconStyle")
                })
            }), Bs(Ns(t.axisPointer), "label"), Bs(Ns(t.tooltip).axisPointer, "label")
        },
        u_ = [
            ["x", "left"],
            ["y", "top"],
    ...
    var p_ = {
        ...
        v_ = {
            ...
            original: function (t, e, n, i) {
                ...
                return !this._rawData.pure && nr(t) && (this.hasItemOption = !0), Zs(r instanceof Array ? r[i] : r, this._dimensionInfos[e])
            },
            ...
            getFormattedLabel: function (t, e, n, i, r) {
                ...
                if ("string" == typeof l) {
                    ...
                    return u.replace(m_, function (e, n) {
                        var i = n.length;
                        return "[" === n.charAt(0) && "]" === n.charAt(i - 1) && (n = +n.slice(1, i - 1)), Ks(a, t, n)
                    })
                }
            },
    ...
    __.perform = function (t) {
        ...
        (o !== l || s !== u) && (a = "reset");
        var h;
        (this._dirty || "reset" === a) && (this._dirty = !1, h = el(this, i)), this._modBy = l, this._modDataCount = u;
        var c = t && t.step;
    ...
    var w_ = lr(),
        b_ = Ey.extend({
            ...
            init: function (t, e, n) {
                ...
                sl(i, this), this.dataTask.context.data = i, w_(this).dataBeforeProcessed = i, nl(this)
            },
            mergeDefaultAndTheme: function (t, e) {
                var n = this.layoutMode,
                    i = n ? Qo(t) : {},
                    a = this.subType;
                Ey.hasClass(a) && (a += "Series"), r(t, e.getTheme().get(this.subType)), r(t, this.getDefaultOption()), tr(t, "label", ["show"]), this.fillDataTextStyle(t.data), n && $o(t, i, n)
            },
            mergeOption: function (t, e) {
                ...
                sl(i, this), this.dataTask.dirty(), this.dataTask.context.data = i, w_(this).dataBeforeProcessed = i, nl(this)
            },
            ...
            formatTooltip: function (t, e, n, i) {
                ...
                var _ = p > 1 || m && !p ? r(v) : a(p ? Ks(c, t, d[0]) : m ? v[0] : v),
                    w = _.content,
    ...
    var A_ = {
        ...
        k_ = "\x00__throttleOriginMethod",
        P_ = "\x00__throttleRate",
        L_ = "\x00__throttleType",
        O_ = {
            createOnAllSeries: !0,
            performRawSeries: !0,
            reset: function (t, e) {
    ...
    N_.restoreData = function (t, e) {
        ...
        f(this._allHandlers, function (i) {
            ...
            i.reset && _l(this, i, r, e, n), i.overallReset && xl(this, i, r, e, n)
        }, this)
    }, N_.prepareView = function (t, e, n, i) {
        var r = t.renderTask,
            a = r.context;
        a.model = e, a.ecModel = n, a.api = i, r.__block = !t.incrementalPrepareRender, Al(this, e, r)
    ...
    var H_, G_ = {},
        W_ = {};
    Pl(G_, $y), Pl(W_, Ss), G_.eachSeriesByType = G_.eachRawSeriesByType = function (t) {
        H_ = t
    ...
    var X_ = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
        ...
        j_ = ["#dd6b66", "#759aa0", "#e69d87", "#8dc1a9", "#ea7e53", "#eedd78", "#73a373", "#73b9bc", "#7289ab", "#91ca8c", "#f49f42"],
        Z_ = {
            color: j_,
            backgroundColor: "#333",
            tooltip: {
    ...
    Ol.prototype.parse = function (t, e) {
        ...
        isNaN(a) && (a = null), isNaN(o) && (o = null), Rl(n, i, null, !0);
    ...
    var Q_ = {
            g: function (t, e) {
                var n = new dg;
                return El(e, n), Rl(t, n, this._defs), n
            },
            rect: function (t, e) {
                var n = new Fm;
                return El(e, n), Rl(t, n, this._defs), n.setShape({
            ...
            polygon: function (t, e) {
                ...
                return El(e, i), Rl(t, i, this._defs), i
            },
            polyline: function (t, e) {
                var n = new ta;
                El(e, n), Rl(t, n, this._defs);
            ...
            image: function (t, e) {
                var n = new Ci;
                return El(e, n), Rl(t, n, this._defs), n.setStyle({
            ...
            text: function (t, e) {
                ...
                var o = new dg;
                return El(e, o), Rl(t, o, this._defs), o
            },
            tspan: function (t, e) {
                ...
                var r = t.getAttribute("dx") || 0,
                    a = t.getAttribute("dy") || 0,
                    o = new dg;
                return El(e, o), Rl(t, o, this._defs), this._textX += r, this._textY += a, o
            },
            path: function (t, e) {
        ...
        Ax = "__optionUpdated",
        kx = /^[a-zA-Z0-9_]+$/;
    Wl.prototype.on = Gl("on", !0), Wl.prototype.off = Gl("off", !0), Wl.prototype.one = Gl("one", !0), c(Wl, xp);
    var Px = Xl.prototype;
    Px._onframe = function () {
        if (!this._disposed) {
            var t = this._scheduler;
            if (this[Ax]) {
                var e = this[Ax].silent;
                this[Dx] = !0, Yl(this), Lx.update.call(this), this[Dx] = !1, this[Ax] = !1, Kl.call(this, e), $l.call(this, e)
                ...
                do {
                    var a = +new Date;
                    t.performSeriesTasks(i), t.performDataProcessorTasks(i), jl(this, i), t.performVisualTasks(i), iu(this, this._model, r, "remain"), n -= +new Date - a
        ...
        if (!this._disposed) {
            ...
            this._model.setOption(t, Rx), n ? (this[Ax] = {
                silent: i
            }, this[Dx] = !1) : (Yl(this), Lx.update.call(this), this._zr.flush(), this[Ax] = !1, this[Dx] = !1, Kl.call(this, i), $l.call(this, i))
        }
        ...
        if (!this._disposed && Qf.canvasSupported) {
            ...
            if (Wx[n]) {
                ...
                return t.connectedBackgroundColor && m.add(new Fm({
                    shape: {
                        x: 0,
                        y: 0,
                        width: p,
    ...
    }, Px.convertToPixel = _(Ul, "convertToPixel"), Px.convertFromPixel = _(Ul, "convertFromPixel"), Px.containPixel = function (t, e) {
        if (!this._disposed) {
            var n, i = this._model;
    ...
    var Lx = {
        ...
        update: function (t) {
            var e = this._model,
                ...
                a = this._scheduler;
            if (e) {
                a.restoreData(e, t), a.performSeriesTasks(e), r.create(e, n), a.performDataProcessorTasks(e, t), jl(this, e), r.update(e, n), tu(e), a.performVisualTasks(e, t), eu(this, e, n, t);
    ...
    Px.resize = function (t) {
        if (!this._disposed) {
            ...
            if (this._loadingFX && this._loadingFX.resize(), e) {
                var n = e.resetOption("media"),
                    i = t && t.silent;
                this[Dx] = !0, n && Yl(this), Lx.update.call(this), this[Dx] = !1, Kl.call(this, i), $l.call(this, i)
            }
        }
        ...
        if (!this._disposed && (hx(e) || (e = {
            ...
            Zl.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : e.flush !== !1 && Qf.browser.weChat && this._throttledZrFlush(), Kl.call(this, e.silent), $l.call(this, e.silent)
        }
    ...
    }, Px.on = Gl("on", !1), Px.off = Gl("off", !1), Px.one = Gl("one", !1);
    ...
    Px._initEvents = function () {
        ...
        if (!this._disposed) {
            this._disposed = !0, cr(this.getDom(), Yx, "");
            var t = this._api,
                e = this._model;
    ...
    var Bx = {},
        ...
        qx = fu;
    Iu(bx, O_), yu(c_), _u(mx, d_), Cu("default", R_), wu({
        type: "highlight",
        event: "highlight",
        update: "highlight"
    }, V), wu({
    ...
    sw.type = "list", sw.hasItemOption = !0, sw.getDimension = function (t) {
        ...
        for (var n = this._chunkSize, i = this._storage, r = this.dimensions, a = r.length, o = this._rawExtent, s = this.count(), l = s + Math.max(t.length, e ? e.length : 0), u = this._chunkCount, h = 0; a > h; h++) {
            var c = r[h];
            o[c] || (o[c] = eh()), i[c] || (i[c] = []), Yu(i, this._dimensionInfos[c], n, u, l), this._chunkCount = i[c].length
        }
        ...
        if (!(t >= e)) {
            for (var n, i = this._chunkSize, r = this._rawData, a = this._storage, o = this.dimensions, s = o.length, l = this._dimensionInfos, u = this._nameList, h = this._idList, c = this._rawExtent, d = this._nameRepeatCount = {}, f = this._chunkCount, p = 0; s > p; p++) {
                ...
                c[g] || (c[g] = eh());
                var v = l[g];
                0 === v.otherDims.itemName && (n = this._nameDimIdx = p), 0 === v.otherDims.itemId && (this._idDimIdx = p), a[g] || (a[g] = []), Yu(a, v, i, f, e), this._chunkCount = a[g].length
            }
        ...
        if (e) {
            ...
            for (var n = Wu(this), t = new n(this.count()), r = 0; r < t.length; r++) t[r] = r;
        return t
    }, sw.get = function (t, e) {
        ...
        return a.length = l, a
    }, sw.getRawIndex = Zu, sw.getRawDataItem = function (t) {
        ...
        if (this._count) {
            "function" == typeof t && (i = n, n = e, e = t, t = []), n = n || i || this, t = p(Qu(t), this.getDimension, this);
        ...
        n = n || i || this, t = p(Qu(t), this.getDimension, this);
        var r = Ju(this, t);
        ...
        var e = this;
        return new zu(t ? t.getIndices() : [], this.getIndices(), function (e) {
            return $u(t, e)
        }, function (t) {
            return $u(e, t)
        })
    ...
    var uw = function (t, e) {
            return e = e || {}, nh(e.coordDimensions || [], t, {
        ...
        hw = {
            cartesian2d: function (t, e, n, i) {
                ...
                e.coordSysDims = ["x", "y"], n.set("x", r), n.set("y", a), sh(r) && (i.set("x", r), e.firstCategoryDimIndex = 0), sh(a) && (i.set("y", a), null == e.firstCategoryDimIndex & (e.firstCategoryDimIndex = 1))
            },
            singleAxis: function (t, e, n, i) {
                var r = t.getReferringComponents("singleAxis")[0];
                e.coordSysDims = ["single"], n.set("single", r), sh(r) && (i.set("single", r), e.firstCategoryDimIndex = 0)
            },
            polar: function (t, e, n, i) {
                var r = t.getReferringComponents("polar")[0],
                    a = r.findAxisModel("radiusAxis"),
                    o = r.findAxisModel("angleAxis");
                e.coordSysDims = ["radius", "angle"], n.set("radius", a), n.set("angle", o), sh(a) && (i.set("radius", a), e.firstCategoryDimIndex = 0), sh(o) && (i.set("angle", o), null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1))
            },
            geo: function (t, e) {
            ...
            parallel: function (t, e, n, i) {
                ...
                f(a.parallelAxisIndex, function (t, a) {
                    var s = r.getComponent("parallelAxis", t),
                        l = o[a];
                    n.set(l, s), sh(s) && null == e.firstCategoryDimIndex && (i.set(l, s), e.firstCategoryDimIndex = a)
                })
            }
        };
    ph.prototype.parse = function (t) {
        ...
        this._isBlank = t
    }, ph.prototype.getLabel = null, vr(ph), xr(ph, {
        registerWhenExtend: !0
    ...
    var mw = "__ec_stack_",
        ...
        Aw = vw.extend({
            ...
            niceExtent: function (t) {
                var e = this._extent;
                if (e[0] === e[1] && (e[0] -= Cw, e[1] += Cw), e[1] === -1 / 0 && 1 / 0 === e[0]) {
                    var n = new Date;
                    e[1] = +new Date(n.getFullYear(), n.getMonth(), n.getDate()), e[0] = e[1] - Cw
                }
            ...
            niceTicks: function (t, e, n) {
                ...
                wh(f, i), this._stepLvl = l, this._interval = u, this._niceExtent = f
            },
            parse: function (t) {
                return +ko(t)
            }
    ...
    var Pw = ph.prototype,
        ...
        Fw = ph.extend({
            ...
            $constructor: function () {
                ph.apply(this, arguments), this._originalScale = new vw
            },
            getTicks: function (t) {
                var e = this._originalScale,
                    n = this._extent,
                    i = e.getExtent();
                return p(Lw.getTicks.call(this, t), function (t) {
                    var r = bo(Rw(this.base, t));
                    return r = t === n[0] && e.__fixMin ? Oh(r, i[0]) : r, r = t === n[1] && e.__fixMax ? Oh(r, i[1]) : r
                }, this)
            },
            getMinorTicks: Lw.getMinorTicks,
            getLabel: Lw.getLabel,
            scale: function (t) {
                return t = Pw.scale.call(this, t), Rw(this.base, t)
            },
            setExtent: function (t, e) {
                var n = this.base;
                t = Nw(t) / Nw(n), e = Nw(e) / Nw(n), Lw.setExtent.call(this, t, e)
            },
            getExtent: function () {
                var t = this.base,
                ...
                var n = this._originalScale,
                    i = n.getExtent();
                return n.__fixMin && (e[0] = Oh(e[0], i[0])), n.__fixMax && (e[1] = Oh(e[1], i[1])), e
            },
            unionExtent: function (t) {
    ...
    var jw = pa({
            ...
            buildPath: function (t, e, n) {
                ...
                if ("none" !== i) {
                    var r = qw[i];
                    r || (i = "rect", r = qw[i]), Yw[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(t, r.shape, n)
                }
            }
        }),
        Zw = {
    ...
    eb.prototype = {
        ...
        dataToCoord: function (t, e) {
            var n = this._extent,
                i = this.scale;
            return t = i.normalize(t), this.onBand && "ordinal" === i.type && (n = n.slice(), gc(n, i.count())), xo(t, tb, n, e)
        },
        coordToData: function (t, e) {
            var n = this._extent,
                i = this.scale;
            this.onBand && "ordinal" === i.type && (n = n.slice(), gc(n, i.count()));
            var r = xo(t, n, tb, e);
    ...
    hb("x", cb, _c, db), hb("y", cb, _c, db), Ey.extend({
        type: "grid",
    ...
    fb.type = "grid", fb.axisPointerEnabled = !0, fb.getRect = function () {
        ...
        function i() {
            f(a, function (t) {
                var e = t.isHorizontal(),
                    ...
                    i = t.inverse ? 1 : 0;
                t.setExtent(n[i], n[1 - i]), Mc(t, e ? r.x : r.y)
            })
        }
        ...
        function n(n) {
            return function (o, s) {
                if (xc(o, t, e)) {
                    ...
                    var u = new ob(n, Rh(o), [0, 0], o.get("type"), l),
                        h = "category" === u.type;
        ...
        function n(t, e) {
            f(t.mapDimension(e.dim, !0), function (n) {
                e.scale.unionExtentFromData(t, hh(t, n))
            })
        }
    ...
    o(fo.prototype, mb), Pu({
        ...
        _renderNormal: function (t) {
            ...
            i.diff(r).add(function (r) {
                ...
                if (c) {
                    var v = Ib[a.type](i, r),
                        m = Xc(a, e, v);
                    m.useStyle(d.getBarItemStyle()), "cartesian2d" === a.type && m.setShape("r", f), p[r] = m
                }
                if (i.hasValue(r)) {
                    if (l) {
                        var y = Sb[a.type](u, g);
                        if (y) return void n.remove(_)
                    }
                    var _ = Mb[a.type](r, g, e, s, !1, h);
                    i.setItemGraphicEl(r, _), n.add(_), Rc(_, i, r, o, g, t, e, "polar" === a.type)
                }
            }).update(function (o, v) {
                var m = i.getItemModel(o),
                    y = Ib[a.type](i, o, m);
                if (c) {
                    var _ = g[v];
                    _.useStyle(d.getBarItemStyle()), "cartesian2d" === a.type && _.setShape("r", f), p[o] = _;
                    var x = Ib[a.type](i, o),
                        w = Wc(e, x, a);
                    Ja(_, {
                        shape: w
                ...
                if (!i.hasValue(o)) return void n.remove(b);
                if (l) {
                    var S = Sb[a.type](u, y);
                    if (S) return void n.remove(b)
                }
                b ? Ja(b, {
                    shape: y
                }, s, o) : b = Mb[a.type](o, y, e, s, !0, h), i.setItemGraphicEl(o, b), n.add(b), Rc(b, i, o, m, y, t, e, "polar" === a.type)
            }).remove(function (t) {
                var e = r.getItemGraphicEl(t);
                "cartesian2d" === a.type ? e && Bc(t, s, e) : e && Ec(t, s, e)
            }).execute();
            var v = this._backgroundGroup || (this._backgroundGroup = new dg);
            v.removeAll();
        ...
        _clear: function (t) {
            ...
            t && t.get("animation") && n && !this._isLargeDraw ? (this._removeBackground(), this._backgroundEls = [], n.eachItemGraphicEl(function (e) {
                "sector" === e.type ? Ec(e.dataIndex, t, e) : Bc(e.dataIndex, t, e)
    ...
    var kb = {
                    ...
                    if ("number" == typeof h && (h = [h, h]), null != l) {
                        ...
                        f([{
                            ...
                            if ("none" !== l[n] && null != l[n]) {
                                var i = Yh(l[n], -c / 2, -d / 2, c, d, s.stroke, !0),
                                    a = e.r + e.offset,
            ...
            axisName: function () {
                ...
                if (n) {
                    ...
                    null != d && (d = d * Db / 180);
                    var f;
                    Zc(r) ? i = Lb(t.rotation, null != d ? d : t.rotation, a) : (i = Uc(t, r, d || 0, u), f = t.axisNameAvailableWidth, null != f && (f = Math.abs(f / Math.sin(i.rotation)), !isFinite(f) && (f = null)));
                    var p = s.getFont(),
                        g = e.get("nameTruncate", !0) || {},
                        v = g.ellipsis,
                        m = D(t.nameTruncateMaxWidth, g.maxWidth, f),
                        y = null != v && null != m ? Cy(n, m, p, v, {
                            minChar: 2,
        ...
        Pb = Ab.makeAxisEventDataBase = function (t) {
            var e = {
        ...
        Lb = Ab.innerTextLayout = function (t, e, n) {
            var i, r, a = Do(e - t);
            return Ao(a) ? (r = n > 0 ? "top" : "bottom", i = "center") : Ao(a - Db) ? (r = n > 0 ? "bottom" : "top", i = "center") : (r = "middle", i = a > 0 && Db > a ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"), {
                rotation: a,
                textAlign: i,
                textVerticalAlign: r
            }
        },
        Ob = Ab.isLabelSilent = function (t) {
            var e = t.get("tooltip");
        ...
        zb = Au({
            ...
            render: function (t, e, n, i) {
                this.axisPointerClass && od(t), zb.superApply(this, "render", arguments), cd(this, t, e, n, i, !0)
            },
            ...
            dispose: function (t, e) {
                dd(this, e), zb.superApply(this, "dispose", arguments)
            }
        }),
        Rb = [];
    ...
    }), Mu(Cx.VISUAL.LAYOUT, _(Ah, "bar")), Mu(Cx.VISUAL.PROGRESSIVE_LAYOUT, xw), Iu({
        seriesType: "bar",
        reset: function (t) {
    ...
    var Hb = vd.prototype,
        Gb = vd.getSymbolSize = function (t, e) {
    ...
    Hb._updateCommon = function (t, e, n, i) {
        ...
        if (!i || t.hasItemOption) {
            ...
            u = v.getModel(Wb).getItemStyle(["color"]), h = v.getModel(Xb).getItemStyle(), c = v.getShallow("symbolOffset"), d = v.getModel(Ub), f = v.getModel(Yb), p = v.getShallow("hoverAnimation"), g = v.getShallow("cursor")
        } else h = o({}, h);
        var m = a.style,
            y = t.getItemVisual(e, "symbolRotate");
        a.attr("rotation", (y || 0) * Math.PI / 180 || 0), c && a.attr("position", [wo(c[0], n[0]), wo(c[1], n[1])]), g && a.attr("cursor", g), a.setColor(l, i && i.symbolInnerColor), a.setStyle(u);
        ...
        Ha(m, h, d, f, {
            ...
            isRectText: !0,
            autoColor: l
        }), a.__symbolOriginalScale = md(n), a.hoverStyle = h, a.highDownOnUpdate = p && s.isAnimationEnabled() ? _d : null, Ra(a)
    ...
    qb.updateData = function (t, e) {
        ...
        r || n.removeAll(), t.diff(r).add(function (i) {
            ...
            var u = r.getItemGraphicEl(l),
                h = t.getItemLayout(s);
            return wd(t, h, s, e) ? (u ? (u.updateData(t, s, o), Ja(u, {
                position: h
    ...
    }, qb.isPersistent = function () {
        return !0
    }, qb.updateLayout = function () {
        var t = this._data;
        t && t.eachItemGraphicEl(function (e, n) {
            var i = t.getItemLayout(n);
            e.attr("position", i)
        })
    }, qb.incrementalPrepareUpdate = function (t) {
        this._seriesScope = Sd(t), this._data = null, this.group.removeAll()
    }, qb.incrementalUpdate = function (t, e, n) {
        function i(t) {
    ...
    var jb = function (t, e, n, i, r, a, o, s) {
            for (var l = Cd(t, e), u = [], h = [], c = [], d = [], f = [], p = [], g = [], v = Md(r, e, o), m = Md(a, t, s), y = 0; y < l.length; y++) {
                var _ = l[y],
                    x = !0;
                switch (_.cmd) {
                    case "=":
                    ...
                    case "+":
                        var S = _.idx;
                        u.push(r.dataToPoint([e.get(v.dataDimsForPoint[0], S), e.get(v.dataDimsForPoint[1], S)])), h.push(e.getItemLayout(S).slice()), c.push(Td(v, r, e, S)), d.push(i[S]), g.push(e.getRawIndex(S));
                        break;
                    case "-":
                        var S = _.idx,
                            M = t.getRawIndex(S);
                        M !== S ? (u.push(t.getItemLayout(S)), h.push(a.dataToPoint([t.get(m.dataDimsForPoint[0], S), t.get(m.dataDimsForPoint[1], S)])), c.push(n[S]), d.push(Td(m, a, t, S)), g.push(M)) : x = !1
                }
        ...
        nS = ta.extend({
            ...
            buildPath: function (t, e) {
                var n = e.points,
                    i = 0,
                    r = n.length,
                    a = Ld(n, e.smoothConstraint);
                if (e.connectNulls) {
                    for (; r > 0 && Dd(n[r - 1]); r--);
                    for (; r > i && Dd(n[i]); i++);
                }
                for (; r > i;) i += Ad(t, n, i, r, r, 1, a.min, a.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1
            }
        }),
        iS = ta.extend({
            type: "ec-polygon",
            ...
            buildPath: function (t, e) {
                var n = e.points,
                    ...
                    a = n.length,
                    o = e.smoothMonotone,
                    s = Ld(n, e.smoothConstraint),
                    l = Ld(i, e.smoothConstraint);
                if (e.connectNulls) {
                    for (; a > 0 && Dd(n[a - 1]); a--);
                    for (; a > r && Dd(n[r]); r++);
                }
                for (; a > r;) {
                    var u = Ad(t, n, r, a, a, 1, s.min, s.max, e.smooth, o, e.connectNulls);
                    Ad(t, i, r + u - 1, u, a, -1, l.min, l.max, e.stackedOnSmooth, o, e.connectNulls), r += u + 1, t.closePath()
                }
            }
        });
    hl.extend({
        ...
        render: function (t, e, n) {
            ...
            i && i.getArea && t.get("clip", !0) && (M = i.getArea(), null != M.width ? (M.x -= .1, M.y -= .1, M.width += .2, M.height += .2) : M.r0 && (M.r0 -= .5, M.r1 += .5)), this._clipShapeForSymbol = M, f && c.type === i.type && I === this._step ? (m && !p ? p = this._newPolygon(u, x, i, v) : p && !m && (g.remove(p), p = this._polygon = null), g.setClipPath(Hd(i, !1, t)), w && d.updateData(a, {
                isIgnore: b,
                clipShape: M
            }), a.eachItemGraphicEl(function (t) {
                t.stopAnimation(!0)
            }), Od(this._stackedOnPoints, x) && Od(this._points, u) || (v ? this._updateAnimation(a, x, i, n, I, y) : (I && (u = Rd(u, i, I), x = Rd(x, i, I)), f.setShape({
                points: u
            }), p && p.setShape({
                points: u,
                stackedOnPoints: x
                ...
                isIgnore: b,
                clipShape: M
            }), I && (u = Rd(u, i, I), x = Rd(x, i, I)), f = this._newPolyline(u, i, v), m && (p = this._newPolygon(u, x, i, v)), g.setClipPath(Hd(i, !0, t)));
            var T = Nd(a, i) || a.getVisual("color");
            ...
            var C = t.get("smooth");
            if (C = Ed(t.get("smooth")), f.setShape({
                    smooth: C,
                ...
                p.useStyle(s(l.getAreaStyle(), {
                    ...
                    opacity: .7,
                    lineJoin: "bevel"
                })), D && (A = Ed(D.get("smooth"))), p.setShape({
                    smooth: C,
                    stackedOnSmooth: A,
                    smoothMonotone: t.get("smoothMonotone"),
                    connectNulls: t.get("connectNulls")
        ...
        highlight: function (t, e, n, i) {
            ...
            if (!(a instanceof Array) && null != a && a >= 0) {
                ...
                if (!o) {
                    ...
                    o = new vd(r, a), o.position = s, o.setZ(t.get("zlevel"), t.get("z")), o.ignore = isNaN(s[0]) || isNaN(s[1]), o.__temp = !0, r.setItemGraphicEl(a, o), o.stopSymbolAnimation(!0), this.group.add(o)
                }
                o.highlight()
        ...
        _updateAnimation: function (t, e, n, i, r, a) {
            var o = this._polyline,
                s = this._polygon,
                l = t.hostModel,
                u = jb(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, a),
                h = u.current,
                c = u.stackedOnCurrent,
                d = u.next,
                f = u.stackedOnNext;
            if (r && (h = Rd(u.current, n, r), c = Rd(u.stackedOnCurrent, n, r), d = Rd(u.next, n, r), f = Rd(u.stackedOnNext, n, r)), Bd(h, d) > 3e3 || s && Bd(c, f) > 3e3) return o.setShape({
                points: d
            }), void(s && s.setShape({
                points: d,
                stackedOnPoints: f
    ...
    Iu(rS("line", "circle", "line")), Mu(aS("line")), _u(Cx.PROCESSOR.STATISTIC, lS("line"));
    var uS = function (t, e, n) {
        ...
        cS = ku({
            type: "series.pie",
            init: function (t) {
                cS.superApply(this, "init", arguments), this.legendVisualProvider = new Gd(y(this.getData, this), y(this.getRawData, this)), this.updateSelectedMap(this._createSelectableList()), this._defaultLabelLine(t)
            },
            mergeOption: function (t) {
                cS.superCall(this, "mergeOption", t), this.updateSelectedMap(this._createSelectableList())
            },
            getInitialData: function () {
                return uS(this, {
                    coordDimensions: ["value"],
                    encodeDefaulter: _(ds, this)
                })
            },
            ...
            getDataParams: function (t) {
                var e = this.getData(),
                    n = cS.superCall(this, "getDataParams", t),
                    i = [];
    ...
    dS.updateData = function (t, e, n) {
        ...
        g && i.attr("cursor", g), Xd(this, t.getItemLayout(e), l.isSelected(t.getName(e)), l.get("selectedOffset"), l.get("animation"));
    ...
    }, dS._updateLabel = function (t, e, n) {
    ...
    var fS = (hl.extend({
            ...
            f(e, function (e) {
                e.update = "updateView", wu(e, function (n, i) {
                    var r = {};
        ...
        gS = Math.PI / 180,
        vS = function (t, e, n, i, r, a) {
            var o, s, l = t.getData(),
                u = [],
                h = !1,
                c = (t.get("minShowLabelAngle") || 0) * gS;
            l.each(function (i) {
                    ...
                    if ("center" === p) S = a.cx, M = a.cy, T = "center";
                        ...
                        if (S = O + 3 * D, M = B + 3 * A, !L) {
                            var E = O + D * (w + e - a.r),
                                ...
                                R = E + (0 > D ? -1 : 1) * b,
                                N = z;
                            S = "edge" === v ? 0 > D ? r + m : r + n - m : R + (0 > D ? -g : g), M = N, I = [
                                [O, B],
                                [E, z],
                                [R, N]
                            ]
            ...
            }), !h && t.get("avoidLabelOverlap") && qd(u, o, s, e, n, i, r, a)
        },
        mS = 2 * Math.PI,
        yS = Math.PI / 180,
        _S = function (t, e, n) {
            e.eachSeriesByType(t, function (t) {
                ...
                if (e.each(i, function (t, n) {
                        ...
                        i = "area" !== w ? 0 === m && b ? y : t * y : mS / v, g > i ? (i = g, M -= g) : I += t;
                        var a = T + C * i;
                        e.setItemLayout(n, {
                            angle: i,
                            startAngle: T,
                ...
                vS(t, f, r.width, r.height, r.x, r.y)
            })
        },
        xS = function (t) {
            return {
    ...
    fS("pie", [{
        ...
        event: "pieunselected",
        method: "unSelect"
    }]), Iu(pS("pie")), Mu(_(_S, "pie")), _u(xS("pie")), Du({
        type: "title",
        layoutMode: {
            type: "box",
            ignoreSize: !0
    ...
    var wS = B_.legend.selector,
        ...
        SS = Du({
            ...
            mergeOption: function (t) {
                SS.superCall(this, "mergeOption", t), this._updateSelector(t)
            },
    ...
    wu("legendToggleSelect", "legendselectchanged", _(Kd, "toggleSelected")), wu("legendAllSelect", "legendselectall", _(Kd, "allSelect")), wu("legendInverseSelect", "legendinverseselect", _(Kd, "inverseSelect")), wu("legendSelect", "legendselected", _(Kd, "select")), wu("legendUnSelect", "legendunselected", _(Kd, "unSelect"));
    var MS = _,
        IS = f,
        TS = dg,
        CS = Au({
            ...
            newlineDisabled: !1,
            init: function () {
                this.group.add(this._contentGroup = new TS), this._backgroundEl, this.group.add(this._selectorGroup = new TS), this._isFirstRender = !0
            },
            ...
            render: function (t, e, n) {
                ...
                if (this._isFirstRender = !1, this.resetInner(), t.get("show", !0)) {
                    ...
                    this.group.attr("position", [p.x - f.x, p.y - f.y]), this.group.add(this._backgroundEl = $d(f, t))
                }
            },
            resetInner: function () {
            ...
            renderInner: function (t, e, n, i, r, a, o) {
                ...
                n.eachRawSeries(function (t) {
                ...
                }), IS(e.getData(), function (r, a) {
                    var o = r.get("name");
                    if (!this.newlineDisabled && ("" === o || "\n" === o)) return void s.add(new TS({
                        newline: !0
                    }));
                    ...
                    if (!l.get(o))
                        if (c) {
                            ...
                            m.on("click", MS(Jd, o, null, i, h)).on("mouseover", MS(tf, c.name, null, i, h)).on("mouseout", MS(ef, c.name, null, i, h)), l.set(o, !0)
                            ...
                            if (!l.get(o) && n.legendVisualProvider) {
                                ...
                                g.on("click", MS(Jd, null, o, i, h)).on("mouseover", MS(tf, null, o, i, h)).on("mouseout", MS(ef, null, o, i, h)), l.set(o, !0)
                            }
                        }, this)
            ...
            _createItem: function (t, e, n, i, r, a, s, l, u, h) {
                ...
                if (y.add(Qd(S, r, v, u, p, m)), !x && a && (a !== r || "none" === a)) {
                    var M = .8 * d;
                    "none" === a && (a = "circle");
                    var I = Yh(a, (c - M) / 2, (d - M) / 2, M, M, m ? l : f, null == g ? !0 : g);
                    y.add(Qd(I, a, v, u, p, m))
                }
                var T = "left" === s ? c + 5 : -5,
                    C = s,
                    D = i.get("formatter"),
                    A = t;
                "string" == typeof D && D ? A = D.replace("{name}", null != t ? t : "") : "function" == typeof D && (A = D(t)), y.add(new Cm({
                    style: Wa({}, _, {
                        text: A,
                        x: T,
                        y: d / 2,
            ...
            layoutInner: function (t, e, n, i, r, a) {
                ...
                Ly(t.get("orient"), o, t.get("itemGap"), n.width, n.height);
                var l = o.getBoundingRect(),
                    u = [-l.x, -l.y];
                if (r) {
                    Ly("horizontal", s, t.get("selectorItemGap", !0));
    ...
    _u(Cx.PROCESSOR.SERIES_FILTER, DS), Ey.registerSubTypeDefaulter("legend", function () {
        return "plain"
    });
    var AS = SS.extend({
            type: "legend.scroll",
            ...
            init: function (t, e, n, i) {
                var r = Qo(t);
                AS.superCall(this, "init", t, e, n, i), nf(this, t, r)
            },
            mergeOption: function (t, e) {
                AS.superCall(this, "mergeOption", t, e), nf(this, this.option, t)
            }
        }),
        kS = dg,
        PS = ["width", "height"],
        ...
        OS = CS.extend({
            ...
            renderInner: function (t, e, n, i, r, a, o) {
                ...
                var l = this;
                OS.superCall(this, "renderInner", t, e, n, i, r, a, o);
            ...
            layoutInner: function (t, e, n, r, a, o) {
                var s = this.getSelectorGroup(),
                    ...
                    c = PS[1 - l],
                    d = LS[1 - l];
                a && Ly("horizontal", s, t.get("selectorItemGap", !0));
            ...
            _layoutContentAndController: function (t, e, n, i, r, a, o) {
                ...
                Ly(t.get("orient"), s, t.get("itemGap"), i ? n.width : null, i ? null : n.height), Ly("horizontal", u, t.get("pageButtonItemGap", !0));
                var h = s.getBoundingRect(),
                    c = u.getBoundingRect(),
    ...
    var BS = function (t, e) {
        ...
        NS = function (t, e, n) {
            ...
            if (s) {
                ...
                ES(s.coordSysMap, function (t, e) {
                    var n = l || t.containPoint(r);
                    ES(s.coordSysAxesInfo[e], function (t) {
                        var e = t.axis,
                            i = cf(u, t);
                        if (!c && n && (!u || i)) {
                            var a = i && i.value;
                            null != a || l || (a = e.pointToData(r)), null != a && rf(t, a, g, !1, d)
                        }
                    })
                });
                var v = {};
                return ES(h, function (t, e) {
                    var n = t.linkGroup;
                    n && !f[e] && ES(n.axesInfo, function (e, i) {
                        var r = f[i];
                        if (e !== t && r) {
                            var a = r.value;
                            n.mapper && (a = t.axis.scale.parse(n.mapper(a, df(e), df(t)))), v[t.key] = a
                        }
                    })
                }), ES(v, function (t, e) {
                    rf(h[e], t, g, !0, d)
                }), lf(f, h, d), uf(p, r, t, o), hf(h, o, n), d
            }
        },
        FS = (Du({
            type: "axisPointer",
        ...
        HS = Au({
            ...
            render: function (t, e, n) {
                ...
                pf("axisPointer", n, function (t, e, n) {
            ...
            remove: function (t, e) {
                xf(e.getZr(), "axisPointer"), HS.superApply(this._model, "remove", arguments)
            },
            dispose: function (t, e) {
                xf("axisPointer", e), HS.superApply(this._model, "dispose", arguments)
            }
        }),
        GS = lr(),
        WS = i,
    ...
    wf.prototype = {
        ...
        createPointerEl: function (t, e) {
            var n = e.pointer;
            if (n) {
                var i = GS(t).pointerEl = new hy[n.type](WS(e.pointer));
                t.add(i)
            }
        },
        createLabelEl: function (t, e, n, i) {
            if (e.label) {
                var r = GS(t).labelEl = new Fm(WS(e.label));
                t.add(r), Mf(r, i)
            }
        },
        updatePointerEl: function (t, e, n) {
            var i = GS(t).pointerEl;
        ...
        _renderHandle: function (t) {
            if (!this._dragging && this.updateHandleTransform) {
                ...
                this._handle || (o = !0, i = this._handle = so(r.get("icon"), {
                    ...
                    onmousedown: XS(this._onHandleDragMove, this, 0, 0),
                    drift: XS(this._onHandleDragMove, this),
                    ondragend: XS(this._onHandleDragEnd, this)
                }), n.add(i)), Tf(i, e, !1);
                ...
                var l = r.get("size");
                x(l) || (l = [l, l]), i.attr("scale", [l[0] / 2, l[1] / 2]), vl(this, "_doDispatchAxisPointer", r.get("throttle") || 0, "fixRate"), this._moveHandleToValue(t, o)
            }
        },
        _moveHandleToValue: function (t, e) {
            bf(this._axisPointerModel, !e && this._moveAnimation, this._handle, If(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)))
        },
        _onHandleDragMove: function (t, e) {
            var n = this._handle;
            if (n) {
                this._dragging = !0;
                var i = this.updateHandleTransform(If(n), [t, e], this._axisModel, this._axisPointerModel);
                this._payloadInfo = i, n.stopAnimation(), n.attr(If(i)), GS(n).lastProp = null, this._doDispatchAxisPointer()
            }
        },
    ...
    }, wf.prototype.constructor = wf, vr(wf);
    var US = wf.extend({
            makeElOption: function (t, e, n, i, r) {
                var a = n.axis,
                    o = a.grid,
                    s = i.get("type"),
                    l = Ef(o, a).getOtherAxis(a).getGlobalExtent(),
            ...
            getHandleTransform: function (t, e, n) {
                var i = fd(e.axis.grid.model, e, {
                    labelInside: !1
                });
                return i.labelMargin = n.get("handle.margin"), {
                    position: Pf(e.axis, t, i),
            ...
            updateHandleTransform: function (t, e, n) {
                var i = n.axis,
                    ...
                    o = Ef(r, i).getOtherAxis(i).getGlobalExtent(),
                    s = "x" === i.dim ? 0 : 1,
                    l = t.position;
        ...
        YS = {
            ...
            shadow: function (t, e, n) {
                ...
                return {
                    type: "Rect",
                    shape: Bf([e - i / 2, n[0]], [i, r], zf(t))
                }
            }
        };
    zb.registerAxisPointerClass("CartesianAxisPointer", US), yu(function (t) {
        if (t) {
            (!t.axisPointer || 0 === t.axisPointer.length) && (t.axisPointer = {});
            var e = t.axisPointer.link;
            e && !x(e) && (t.axisPointer.link = [e])
        }
    }), _u(Cx.PROCESSOR.STATISTIC, function (t, e) {
    ...
    var qS = f,
        jS = No,
        ZS = ["", "-webkit-", "-moz-", "-o-"],
        KS = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
    Hf.prototype = {
        constructor: Hf,
        _enterable: !0,
        update: function () {
        ...
        show: function (t) {
            ...
            var e = this.el,
                n = this._styleCoord;
            e.style.cssText = KS + Ff(t) + ";left:" + n[0] + "px;top:" + n[1] + "px;" + (t.get("extraCssText") || ""), e.style.display = e.innerHTML ? "block" : "none", e.style.pointerEvents = this._enterable ? "auto" : "none", this._show = !0
        },
        ...
        moveTo: function (t, e) {
            ...
            Vf(n, this._zr, this._appendToBody, t, e);
            var i = this.el.style;
    ...
    Au({
        ...
        _initGlobalListener: function () {
            var t = this._tooltipModel,
                e = t.get("triggerOn");
            pf("itemTooltip", this._api, $S(function (t, n, i) {
        ...
        manuallyHideTip: function (t, e, n, i) {
            ...
            !this._alwaysShowContent && this._tooltipModel && r.hideLater(this._tooltipModel.get("hideDelay")), this._lastX = this._lastY = null, i.from !== this.uid && this._hide(Xf(i, n))
        },
        _manuallyAxisShowTip: function (t, e, n, i) {
            ...
            if (null != r && null != a && null != o) {
                ...
                if (s) {
                    var l = s.getData(),
                        t = Wf([l.getItemModel(a), s, (s.coordinateSystem || {}).model, t]);
        ...
        _showAxisTooltip: function (t, e) {
            var n = this._ecModel,
                ...
                o = [],
                s = [],
                l = Wf([e.tooltipOption, i]),
                u = this._renderMode,
                h = this._newLine,
                c = {};
            QS(t, function (t) {
                QS(t.dataByAxis, function (t) {
                    var e = n.getComponent(t.axisDim + "Axis", t.axisIndex),
                        i = t.value,
                        a = [];
                    if (e && null != i) {
                        var l = kf(i, e.axis, n, t.seriesDataIndices, t.valueLabelOpt);
                        f(t.seriesDataIndices, function (o) {
                            var h = n.getSeriesByIndex(o.seriesIndex),
                                d = o.dataIndexInside,
                                f = h && h.getDataParams(d);
                            if (f.axisDim = t.axisDim, f.axisIndex = t.axisIndex, f.axisType = t.axisType, f.axisId = t.axisId, f.axisValue = Vh(e.axis, i), f.axisValueLabel = l, f) {
                                s.push(f);
        ...
        _showSeriesItemTooltip: function (t, e, n) {
            var i = this._ecModel,
                ...
                l = e.dataType,
                u = o.getData(l),
                h = Wf([u.getItemModel(s), o, a && (a.coordinateSystem || {}).model, this._tooltipModel]),
                c = h.get("trigger");
            if (null == c || "item" === c) {
        ...
        _updatePosition: function (t, e, n, i, r, a, o) {
            ...
            if (o && d.applyTransform(o.transform), "function" == typeof e && (e = e([n, i], a, r.el, d, {
                ...
                var p = Uf(n, i, r, s, l, h ? null : 20, c ? null : 20);
                n = p[0], i = p[1]
            }
            if (h && (n -= jf(h) ? u[0] / 2 : "right" === h ? u[0] : 0), c && (i -= jf(c) ? u[1] / 2 : "bottom" === c ? u[1] : 0), t.get("confine")) {
                var p = Yf(n, i, r, s, l);
                n = p[0], i = p[1]
            }
            r.moveTo(n, i)
        ...
        _updateContentNotChangedOnAxis: function (t) {
            ...
            return n && QS(e, function (e, i) {
                var r = e.dataByAxis || {},
                    a = t[i] || {},
                    o = a.dataByAxis || [];
                n &= r.length === o.length, n && QS(r, function (t, e) {
                    var i = o[e] || {},
                        r = t.seriesDataIndices || [],
                        a = i.seriesDataIndices || [];
                    n &= t.value === i.value && t.axisType === i.axisType && t.axisId === i.axisId && r.length === a.length, n && QS(r, function (t, e) {
                        var i = a[e];
        ...
        dispose: function (t, e) {
            Qf.node || (this._tooltipContent.dispose(), xf("itemTooltip", e))
        }
    }), wu({
        type: "showTip",
        event: "showTip",
